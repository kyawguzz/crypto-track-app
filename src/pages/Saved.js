...
const Saved = () => {
  ...
  return (
    <section className="lg:w-[90%] w-[95%] h-full flex flex-col mt-14 mb-24 relative">
                ...
                {savedData &&
                  savedData.map((data) => {
                    return (
                      ...
                      <tr
                        key={data.id}
                        className="text-center text-s border-b border-gray-100  hover:bg-gray-200"
                      >
                        ...
                        <td className="py-4 cursor-pointer lg:table-cell hidden">
                          <Link to={`${data.id}`} className="cursor-pointer">
                            {data.name}
                          </Link>
                        </td>
