...
const CryptoDetail = () => {
  ...
  return ReactDOM.createPortal (
    ...
    >
      <div 
        className="lg:w-[75%] w-[90%] lg:h-[85%] h-[70%] bg-gray-300 bg-opacity-75 rounded-lg text-white relative border border-[#b3b3b3]"
        onClick= {(e) => e.stopPropagation()}
      >
        {
          data ? (
            <div className='flex items-center justify-between h-full w-full p-1 lg:p-4 flex-row'>
              {/* left */}
                <div className='flex flex-col w-[45%] h-full pr-2'>
                    <div className='flex w-full items-center'>
                      <img src={data.image.large} alt={data.id} className='lg:w-[2rem] lg:h-[2rem] w-[1rem] h-[1rem] mx-1.5'/>
                      <h1 className='lg:text-lg text:base capitalize font-medium '>{data.name}</h1>
                      <span className='hidden lg:flex text-sm py-0.5 px-2 ml-1 bg-cyan text-cyan bg-opacity-25 rounded uppercase'>
                        {data.symbol}
                      </span>
                    </div>
                    {/* price */}
                    <div className='flex w-full lg:mt-6 mt-3'>
                      <div className='flex flex-col w-full'>
                          <div className='flex justify-between'>
                              <span className='lg:text-sm text-s capitalize text-gray-100'>Price</span>
                              <div className={`lg:text-sm text-s px-1 ml-2 font-medium flex 
                          ...
                          <h2 className='lg:text-sm text-s font-bold'>
                    ...
                    {/* meketCapandFullyDilutedValuation */}
                    <div className="flex w-full lg:mt-4 mt-2 justify-between lg:flex-row flex-col">
                      <div className="flex flex-col">
                        <span className="lg:text-sm text-s capitalize text-gray-100">
                          Market Cap
                        </span>
                        <h2 className="lg:text-sm text-s font-bold">
                          {new Intl.NumberFormat("en-IN", {
                    ...
                    {/* totalVolume */}
                    <div className="flex flex-col w-full lg:mt-4 mt-2 justify-between">
                      <span className="lg:text-sm text-s capitalize text-gray-100">
                        total volume
                      </span>
                      <h2 className="lg:text-sm text-s font-bold">
                    ...
                    {/* maxSupplyAndCirculatingSupply */}
                    <div className="flex w-full lg:mt-4 mt-2 justify-between lg:flex-row flex-col">
                      <div className="flex flex-col">
                        <span className="lg:text-sm text-s capitalize text-gray-100">
                          max supply
                        </span>
                        <h2 className="lg:text-base text-s font-bold">
                          {new Intl.NumberFormat("en-IN", {
                            style: "currency",
                            currency: currency,
                            minimumFractionDigits: 0,
                     ...
                     <div className='flex w-full lg:mt-4 mt-10 justify-between'>
                          {/* links */}
                          ...
                          <div className='flex flex-col content-start'>
                              <span className='lg:text-base text-sm'>sentiment</span>
                              <div className="flex justify-between">
                                <div
                ...
                <div className='flex flex-col w-[55%] h-full pl-3'>
                    ...
                    <div className='flex flex-col lg:mt-4 mt-20'>
                        <div className='text-white py-0 lg:text-sm text-s'>
                          <span className='text-gray-100 capitalize mr-1 '>market cap rank:</span> {data.market_cap_rank}
                        </div>
                        <div className='text-white py-0 lg:text-sm text-s'>
                          <span className='text-gray-100 capitalize mr-1'>coinGecko rank:</span> {data.coingecko_rank}
                        </div>
                        <div className='text-white py-0 lg:text-sm text-s'>
                          <span className='text-gray-100 capitalize mr-1'>coinGecko score:</span> {data.coingecko_score}
                        </div>
                    </div>

                    <div className="lg:absolute lg:bottom-8 mt-9 right-8 flex items-center">
            ...
            <div className='w-full min-h-[60vh] h-full flex justify-center items-center'>
                            <div 
                                ...
                                role="status"
                            />
                            <span className='ml-2'>wait a second....</span>
                        </div>
          )
        }
      </div>
