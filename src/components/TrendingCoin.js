...
const TrendingCoin = ({data}) => {
  ...
  return (
    <div 
        ...
        className="lg:w-[40%] w-[95%] border border-white mb-12 last:mb-0 rounded-lg p-4 relative cursor-pointer hover:bg-gray-100 hover:bg-opacity-40">
        {data ? (
           <>
                ...
                <img
                    src={data.large}
                    alt={data.name}
                    className="w-[15%] h-auto rounded-full absolute top-2/4 lg:right-10 right-1
                        -translate-y-2/4"
                />
           </>
        ):(
